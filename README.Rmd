...
The main package dataset has `r nlevels(gapminder$country)` * 12 = `r nrow(gapminder)` rows, whereas the larger, unfiltered dataset contains 3313 rows, almost twice as much data.
