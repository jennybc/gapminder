...
Cleaning history
  ...
  * 2014: I re-cleaned the data and (mostly) forced myself to pull it straight
  out of the spreadsheets. Used the `gdata` package. It was kind of painful, due to encoding and other issues. See these scripts here *link to version of this directory at initial CRAN release*.
